...
public class ASObject
  ...
  public static abstract class AbstractBuilder
    ...
    protected B _dtNow(String key) {
      return _dt(key, ZonedDateTime.now(UTC));
    }
    ...
    protected B _dtFromNow(String key, Duration duration) {
      return _dt(key, ZonedDateTime.now(UTC).plus(duration));
    }
     ...
     * @return B
     **/
    protected B _dtFromNow(String key, Period period) {
      return _dt(key, ZonedDateTime.now(UTC).plus(period));
    }
     ...
     * @return B
     */
    protected B _dtFrom(String key, ZonedDateTime dt, Period period) {
     ...
     *   .publishedFromNow(Duration.ofDays(-1))
     *   .get();
     * <pre>
     * @param duration Duration
     * @return B
     ...
     * // Published one day ago
     * ASObject obj = Makers.object()
     *   .publishedFromNow(Period.ofDays(-1))
     *   .get();
     * <pre>
     * @param period Period
     * @return B
     **/
    public B publishedFromNow(Period period) {
     ...
     * // Published one day ago
     * ASObject obj = Makers.object()
     *   .updatedFromNow(Duration.ofDays(-1))
     *   .get();
     * <pre>
     * @param duration Duration
     * @return B
     ...
     * // Published one day ago
     * ASObject obj = Makers.object()
     *   .updatedFromNow(Period.ofDays(-1))
     *   .get();
     * <pre>
     * @param period Period
     * @return B
     **/
    public B updatedFromNow(Period period) {
     ...
     * // Published one day ago
     * ASObject obj = Makers.object()
     *   .startTimeFromNow(Duration.ofDays(-1))
     *   .get();
     * <pre>
     * @param duration Duration
     * @return B
     ...
     * // Published one day ago
     * ASObject obj = Makers.object()
     *   .startTimeFromNow(Period.ofDays(-1))
     *   .get();
     * <pre>
     * @param period Period
     * @return B
     **/
    public B startTimeFromNow(Period period) {
     ...
     * @return B
     **/
    public B endTimeFromNow(Period period) {
    ...
    public B duration(long s) {
      return duration(ofSeconds(checkNotNegative(s)));
    }

    /**
     * Set the duration as a java.time.Duration
     * @param d Duration
     * @return B
     **/
    ...
    /**
     * Set the duration as a java.time.Period
     * @param period Period
     * @return B
     */
    public B duration(Period period) {
      return duration(toDuration(period));
    }
     ...
     * @return B
     */
    public B durationFrom(Period p, ZonedDateTime dt) {
      return duration(Duration.between(dt, dt.plus(p)));
    }
     ...
     * @return B
     */
    public B durationFromNow(Period p) {
      ZonedDateTime now = ZonedDateTime.now(UTC);
      return duration(Duration.between(now, now.plus(p)));
    }
  ...
  /**
   * Return the value of the property if it exists, casting to a ZonedDateTime
   * object.
   * @param key String
